...
return function(plume)
	...
	function plume.safeRun(run, runtime, startip, fileId, variadicParam, namedParamOffset, fileParams)
		local novmcrash, success, result, ip = xpcall(run, plume.error.vmCrashHandler, runtime, startip, fileId, variadicParam, namedParamOffset, fileParams)
